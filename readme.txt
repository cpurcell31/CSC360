...
Part 2 is implemented to handle subdirectories
Part 3 is implemented to handle subdirectories
Part 5 is only attempts to fix case 1 type errors in the FAT
